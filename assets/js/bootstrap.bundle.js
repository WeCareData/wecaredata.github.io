...
(function (global, factory) {
  ...
  /**
   * --------------------------------------------------------------------------
   * Bootstrap (v5.0.0-beta1): dom/activity-handler.js
   * Licensed under MIT (https://github.com/twbs/bootstrap/blob/main/LICENSE)
   * --------------------------------------------------------------------------
   */
  /**
  ...
  var EventHandler = {
    ...
    trigger: function trigger(element, event, args) {
      ...
      } // merge custom information in our activity
  ...
  var CLASS_NAME_POINTER_EVENT = 'pointer-activity';
    ...
    _proto._addTouchEventListeners = function _addTouchEventListeners() {
      ...
      var end = function end(event) {
        ...
        if (_this4._config.pause === 'hover') {
          ...
          // (as if it's the second time we tap on it, mouseenter compat activity
  ...
  */
  ...
  var Dropdown = /*#__PURE__*/function (_BaseComponent) {
    ...
    _proto.show = function show() {
      ...
      // only needed because of broken activity delegation on iOS
  ...
  var Modal = /*#__PURE__*/function (_BaseComponent) {
    ...
    _proto.dispose = function dispose() {
       ...
       * It will remove `EVENT_CLICK_DATA_API` activity that should remain
       */
